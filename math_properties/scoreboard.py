...
class Scoreboard():
    ...
    """
        ...
        """
                ...
                if(length == 0):
                        self.text = ("Scoreboard:\nearned points: %d \npoints till next level: %d\n %s+ = + " %(self.score, points_left, ''))
                elif(length == 1):
                        self.text = ("Scoreboard:\nearned points: %d \npoints till next level: %d\n %s+ = + " %(self.score, points_left, self.basket_list[0]))
                elif(length == 2):
                        self.text = ("Scoreboard:\nearned points: %d \npoints till next level: %d\n %s+ %s= + " %(self.score, points_left, self.basket_list[0], self.basket_list[1]))
                elif(length == 3):
                        self.text = ("Scoreboard:\nearned points: %d \npoints till next level: %d\n %s+ %s= %s+ " %(self.score, points_left, self.basket_list[0], self.basket_list[1], self.basket_list[2]))
                elif(length == 4):
                        self.text = ("Scoreboard:\nearned points: %d \npoints till next level: %d\n %s+ %s= %s+ %s" %(self.score, points_left, self.basket_list[0], self.basket_list[1], self.basket_list[2], self.basket_list[3]))
